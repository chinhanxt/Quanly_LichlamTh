...
describe('Telegram Webhook API', () => {
  ...
  it('should handle /start command and return 200 OK', async () => {
    const payload = {
      ...
      message: {
        message_id: 1,
        from: { id: 5842766685, first_name: 'TestUser' },
        chat: { id: 5842766685, type: 'private' },
        date: 1700000000,
        text: '/start',
      },
    };
  ...
  it('should set AWAITING_NOTE state on ➕ Thêm Ghi Chú and save note on next text message', async () => {
    ...
    saveSettingsForUserLocal('thanhhuong', { ...s, allowedChatIdsStr: '5842766685', telegramChatId: '5842766685' });
