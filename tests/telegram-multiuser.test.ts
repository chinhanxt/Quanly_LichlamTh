...
test('Multi-User Database Scoping', async (t) => {
  ...
  await t.test('should route Telegram webhook to correct user based on chatId', async () => {
    ...
    await saveSettingsForUser('test_user_a', { ...backupUserA, telegramBotToken: 'mock-token', telegramChatId: '5842766685', allowedChatIdsStr: '5842766685, 10001', telegramSessionState: { userState: 'IDLE' }, userNotes: [] });
