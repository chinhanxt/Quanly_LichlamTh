...
import { getScheduleItems, getSettings, updateSettings, saveSettingsForUser } from '@/lib/firebase';
...
export async function GET(request: Request) {
  try {
    ...
    if (logUpdated) {
      await saveSettingsForUser(settings.username || 'thanhhuong', { ...settings, sentRemindersLog: sentLog });
    }
