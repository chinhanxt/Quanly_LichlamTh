...
import { Calendar, Wallet, StickyNote, Receipt } from 'lucide-react';

interface BottomNavProps {
  activeTab: 'schedule' | 'salary' | 'notes' | 'expense' | 'notifications' | 'settings';
  onChangeTab: (tab: 'schedule' | 'salary' | 'notes' | 'expense' | 'notifications' | 'settings') => void;
  isChinhan?: boolean;
}
