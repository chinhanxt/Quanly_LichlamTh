...
export default function LocketTab() {
  ...
  return (
    <div className="max-w-md mx-auto p-3 space-y-3 pb-24 select-none">
      ...
      <div
        ...
        className="relative aspect-square w-full bg-slate-950 rounded-3xl overflow-hidden shadow-2xl border-4 border-white ring-1 ring-purple-200/80 flex items-center justify-center group touch-none select-none"
      >
        {previewUrl ? (
